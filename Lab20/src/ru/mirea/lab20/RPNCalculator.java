...
public class RPNCalculator extends JFrame {
    ...
    public RPNCalculator() {
        ...
        // Инициализация и настройка текстовых полей
        ...
        // Инициализация и настройка панели с кнопками
        ...
        this.add(jPanel); // Добавление панели с кнопками на окно
        this.setDefaultCloseOperation(EXIT_ON_CLOSE);
        this.setVisible(true);
    }

    // Внутренний класс для обработки событий кнопок
    class MyActionListener implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            ...
            // Обработка нажатия кнопок с операторами
                ...
                if (!operandStack.isEmpty()) {
                    ...
                    if (!operandStack.isEmpty()) {
                        ...
                        jTextField.setText(getPrettyNumber(Double.toString(result)));
                        currentExpression.setLength(currentExpression.length() - 2);
                    } else {
                        jTextField.setText("");
                        currentExpression.setLength(0);
                    }
            ...
            // Обновление текстового поля с текущим выражением
